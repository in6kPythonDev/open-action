...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.referral'
        db.add_column(u'vote', 'referral',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vote.is_anonymous'
        db.add_column(u'vote', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vote.text'
        db.add_column(u'vote', 'text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.referral'
        db.delete_column(u'vote', 'referral_id')

        # Deleting field 'Vote.is_anonymous'
        db.delete_column(u'vote', 'is_anonymous')

        # Deleting field 'Vote.text'
        db.delete_column(u'vote', 'text')
    ...
    models = {
        ...
        'askbot.vote': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'referral': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
